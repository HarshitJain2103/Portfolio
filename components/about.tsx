...
const statements = [
  ...
  "Building scalable architectures with reliability.",
  "Full-stack engineer focused on user experience.",
  "4× Hackathon winner, 1700+ LeetCode rating.",
  "Cloud & DevOps expertise with AWS.",
]
...
export function About() {
  ...
  return (
    <section id="about" ref={containerRef} className="relative py-32 overflow-hidden md:py-0">
      ...
      >
        <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">03 — EXPERTISE</p>
